            ...
            <div class="row">
              ...
              <div class="col-md-6 col-12">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="address" id="address" class="form-control  @error('address') is-invalid @enderror" placeholder="Suryabinayak-4 Bhaktapur" value="{{old('address')}}" required >
                  @error('address') 
                    <small class="text-danger">{{ $message }}</small>
                  @enderror
                </div>
